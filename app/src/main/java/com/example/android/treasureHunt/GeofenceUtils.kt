...
internal object GeofencingConstants {
    ...
    val LANDMARK_DATA = arrayOf(
        LandmarkDataObject(
            "english_courses_class",
            R.string.english_courses_class,
            R.string.english_courses_class_location,
            LatLng(-6.309150, 106.955812)),

        LandmarkDataObject(
            "post_satpam",
            R.string.post_satpam,
            R.string.post_satpam_location,
            LatLng(-6.309342, 106.956509))
